                ...
                <div class="container">
                    <div class="row d-flex justify-content-center text-center">
                        <div class="col-lg-8">
                            ...
                            <p class="mb-0">Pilih jenis surat yang Anda butuhkan untuk memulai proses permohonan online.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-10">
                        ...
                        <p class="text-center mb-5 lead-intro">
                            Telusuri daftar lengkap surat yang tersedia. Klik <b>Ajukan Permohonan</b> untuk memulai proses
                        ...
                        <div class="row g-4">
                            ...
                            @forelse ($jenisSurats as $surat)
                                    ...
                                    <article class="card p-4 h-100 jenis-surat-card">
                                        <div class="card-body p-0">
                                            <div class="d-flex align-items-start">
                                                {{-- ICON --}}
                                                <i
                                                    class="bi {{ $surat->icon ?? 'bi-file-earmark-text-fill' }} me-4 flex-shrink-0 card-icon"></i>
                                                <div>
                                                    @if ($surat->kode)
                                                        <span class="badge bg-secondary mb-2 rounded-pill">KODE:
                                                            {{ $surat->kode }}</span>
                                                    @endif
                                ...
                                {{-- Modal Syarat --}}
                                <div class="modal fade" id="syaratModal{{ $surat->jenis_id }}" tabindex="-1"
                                    aria-labelledby="syaratModalLabel{{ $surat->jenis_id }}" aria-hidden="true">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                @else
                                                    <div class="alert alert-warning">
                                                        <i class="bi bi-exclamation-triangle-fill me-2"></i> Belum ada
                                                        daftar persyaratan untuk surat ini.
                                                    </div>
                                                @endif
                                            </div>
